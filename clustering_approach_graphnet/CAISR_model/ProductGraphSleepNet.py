...
def build_ProductGraphSleepNet(k, num_of_chev_filters, num_of_time_filters, time_conv_strides, cheb_polynomials, time_conv_kernel, 
    ...
    data_layer = Input(shape=sample_shape, name='Input-Data')
    ...
    nclass = 5 # sleep staging 
    softmax, H = GraphWiseAttentionNetwork(nclass, attn_heads=attn_heads,
    ...
    model.compile(
        ...
        loss='categorical_crossentropy',
        metrics=metrics)
    Hfunc = models.Model(inputs=model.input, outputs=H)
